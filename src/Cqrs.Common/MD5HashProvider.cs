...
{
    /// <summary>
    /// https://github.com/sixeyed/codegallery/tree/master/GuidGenerator/GuidGenerator
    /// </summary>
    public sealed class Md5HashProvider
    {
        public static byte[] ComputeHash(byte[] inputBuffer)
        {
            ...
            int startIndex = 0;
            while (startIndex <= inputBuffer.Length - 64)
            {
                GetHashBlock(inputBuffer, ref abcd, startIndex);
                startIndex += 64;
            }
            // The final data block. 
            return GetHashFinalBlock(inputBuffer, startIndex, inputBuffer.Length - startIndex, abcd, (Int64)inputBuffer.Length * 8);
        }

        private static byte[] GetHashFinalBlock(byte[] input, int ibStart, int cbSize, ABCD ABCD, Int64 len)
        {
        ...
        //    D = 0x10325476;
        */
        private static void GetHashBlock(byte[] input, ref ABCD ABCDValue, int ibStart)
        {
